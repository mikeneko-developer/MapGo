...
open class ActivityNavigator {
    ...
    fun replaceFragmentInSecondContentFrame(tag: String) {
        activity?.replaceFragmentInContentFrame(tag,BaseActivity.DEFAULT_CONTENT_VIEW_SECOND,null)
    }
    ...
    fun replaceFragmentToBackStackInPopupContentFrame(tag: String) {
        activity?.replaceFragmentToBackStackInContentFrame(tag,BaseActivity.DEFAULT_CONTENT_VIEW_POPUP,null)
    }
