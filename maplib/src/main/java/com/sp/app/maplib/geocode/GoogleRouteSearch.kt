...
import com.sp.app.maplib.data.MapCheckPoint
import com.sp.app.maplib.data.MapLocation
import com.sp.app.maplib.data.MapRoute
import com.sp.app.maplib.util.MyAccess
...
class GoogleRouteSearch(val context: Context, val listener: onSearchRouteListener):
    ...
    private fun searchRoute(points: ArrayList<MapLocation>) {
        ...
        // スタート位置を追加
        searchRoutesData.startPoint = com.sp.app.maplib.ui.map.geocode.Location(start.latitude, start.longitude)
